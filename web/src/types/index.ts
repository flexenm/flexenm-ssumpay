...
export const INQUIRY_TYPE = { CHARGE: 1, PAYMENT: 2, CANCEL_REFUND: 3, ETC: 4 } as const
...
export type ProductSubcategory = (typeof PRODUCT_SUBCATEGORY)[keyof typeof PRODUCT_SUBCATEGORY]
